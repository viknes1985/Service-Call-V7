...
import { Search, Plus, User, LogIn, LogOut, ChevronRight, MapPin, Clock, Phone, Camera, X, Filter, ChevronLeft, Trash2, Wrench, PhoneCall, Star, Check, Shield, AlertCircle, Menu, Info, Mail } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen pb-20 font-sans transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      {/* Header */}
      <header className={`${isDarkMode ? 'bg-gray-800' : 'bg-blue-600'} text-white p-4 sticky top-0 z-40 shadow-md flex items-center justify-center relative transition-colors duration-300`}>
        ...
        <div className="flex items-center gap-2">
          <div className={`${isDarkMode ? 'bg-gray-700' : 'bg-white'} p-1 rounded-xl shadow-sm transition-colors`}>
      ...
      <main className="p-4 max-w-md mx-auto">
        {user && (
          <div className="mb-4 animate-in fade-in slide-in-from-left-4 duration-500">
            <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">Hi {user.firstName}</h2>
          </div>
        )}
        <AnimatePresence mode="wait">
          {activeTab === 'home' && (
            ...
            >
              <div className="text-center w-full">
                <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap overflow-hidden text-ellipsis">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="bg-white dark:bg-gray-800 border-blue-100 dark:border-gray-700 p-6 rounded-2xl shadow-sm border flex flex-col items-center gap-3 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors"
                >
                  <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 p-3 rounded-full">
                    <Plus size={28} />
                  </div>
                  <span className="font-semibold text-gray-800 dark:text-gray-200">New Service</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="font-semibold text-gray-800 dark:text-gray-200">Find Service</span>
                </button>
              </div>

              {/* Top Categories Section */}
              <section>
                <h2 className="text-lg font-bold mb-4 text-gray-900 dark:text-gray-100">Top Categories</h2>
                <div className="grid grid-cols-2 gap-4">
                  {topCategories.length > 0 ? (
                    topCategories.map((cat, idx) => (
                      <div
                        ...
                        className="bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm border overflow-hidden cursor-pointer hover:shadow-md transition-all group"
                      >
                        {/* 2x2 Image Grid */}
                        <div className="aspect-square grid grid-cols-2 gap-0.5 p-0.5 bg-gray-100 dark:bg-gray-700">
                          {[0, 1, 2, 3].map(i => (
                            <div key={i} className="bg-white dark:bg-gray-800 overflow-hidden flex items-center justify-center">
                              {cat.thumbnails && cat.thumbnails[i] ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center p-0.5 bg-white dark:bg-gray-800">
                                  <img 
                        ...
                        <div className="p-3 flex justify-between items-center">
                          <div className="flex flex-col overflow-hidden">
                            <span className="font-bold text-sm truncate text-gray-800 dark:text-gray-200">{cat.category}</span>
                            <span className="text-[10px] text-gray-400 dark:text-gray-500">{cat.count} services</span>
                          </div>
                          <ChevronRight size={16} className="text-gray-300 dark:text-gray-600 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors flex-shrink-0" />
                        </div>
                      </div>
                    ))
                  ) : (
          ...
          {activeTab === 'find' && (
            ...
            >
              ...
              <div className="bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 p-4 rounded-2xl shadow-sm space-y-3 border transition-colors">
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={18} />
                  <input
                    type="text"
                    placeholder="Search services..."
                    className="w-full pl-10 pr-4 py-3 border-none rounded-xl focus:ring-2 focus:ring-blue-500 outline-none bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 transition-colors"
                    value={searchQuery}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    className="p-2 rounded-lg text-sm outline-none border-none focus:ring-1 focus:ring-blue-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                    value={filterState}
                    onChange={(e) => {
                  ...
                  <select
                    className="p-2 rounded-lg text-sm outline-none border-none focus:ring-1 focus:ring-blue-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-colors disabled:opacity-50"
                    value={filterTown}
                ...
                <select
                  className="w-full p-2 rounded-lg text-sm outline-none border-none focus:ring-1 focus:ring-blue-500 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-colors"
                ...
                <div className="space-y-3 py-2">
                  <div className="flex justify-between items-center">
                    <label className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Rating Range</label>
                  ...
                  <div className="relative h-6 flex items-center">
                    ...
                    <input
                      ...
                      className="absolute w-full h-1.5 appearance-none bg-transparent pointer-events-none z-20 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-blue-600 dark:[&::-webkit-slider-thumb]:border-blue-400 [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md"
                    />
                    <input
                      type="range"
                      min="0"
                  ...
                  <div className="flex justify-between px-1">
                    {[0, 1, 2, 3, 4, 5].map(tick => (
                      <span key={tick} className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">{tick}</span>
                    ))}
                  </div>
                </div>
                    ...
                    >
                      {service.ratingCount > 0 && (
                        <div className="absolute top-2 right-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-1.5 py-0.5 rounded-lg shadow-sm flex items-center gap-1 z-10 border border-gray-100 dark:border-gray-700">
                          ...
                          <span className="text-[10px] font-bold text-gray-700 dark:text-gray-200">{(service.avgRating || 0).toFixed(1)}</span>
                          <span className="text-[8px] text-gray-400 dark:text-gray-500">({service.ratingCount})</span>
                        </div>
                      )}
                      ...
                      <div className="space-y-1">
                        <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">{service.category}</span>
                        <h3 className="text-sm font-bold text-gray-900 dark:text-white truncate">{service.providerName}</h3>
                        <div className="flex items-center gap-1 text-gray-400 dark:text-gray-500 text-[10px]">
                          <Clock size={10} />
                          <span>{service.operatingHours}</span>
                        </div>
                        {service.creatorName && (
                          <div className="flex items-center gap-1 text-gray-400 dark:text-gray-500 text-[10px] mt-1">
                            <User size={10} />
            ...
            >
              {user ? (
                <div className="space-y-6">
                  <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'} p-6 rounded-2xl shadow-sm text-center space-y-4 border`}>
                  ...
                  <section>
                    ...
                    <div className="space-y-3">
                      {userServices.length > 0 ? (
                        userServices
                          .filter(s => !isAdmin || s.providerName.toLowerCase().includes(adminSearch.toLowerCase()))
                          .map(service => (
                        ...
                        <div className="text-center py-8 text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-800 rounded-xl border border-dashed border-gray-200 dark:border-gray-700 transition-colors">
...
function AuthScreen({ onLogin }: { onLogin: (user: UserProfile) => void }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm space-y-6 transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {mode === 'signup' && (
          <div className="grid grid-cols-2 gap-3">
            <input
              ...
              required
              className="w-full bg-gray-50 dark:bg-gray-700 p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 text-gray-900 dark:text-white dark:placeholder-gray-400 transition-colors"
        ...
        {(mode === 'login' || mode === 'signup' || mode === 'forgot' || mode === 'verify' || mode === 'reset') && (
          <input
            ...
            className="w-full bg-gray-50 dark:bg-gray-700 p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-50 text-gray-900 dark:text-white dark:placeholder-gray-400 transition-colors"
        ...
        {(mode === 'verify' || mode === 'reset') && (
          <input
            ...
            maxLength={6}
            disabled={mode === 'reset'}
            className="w-full bg-gray-50 dark:bg-gray-700 p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 text-center font-mono tracking-widest disabled:opacity-50 text-gray-900 dark:text-white dark:placeholder-gray-400 transition-colors"
            value={formData.code}
...
function NewServiceModal({ user, serviceToEdit, onClose, onSuccess }: { user: UserProfile | null, serviceToEdit?: Service | null, onClose: () => void, onSuccess: (isNew: boolean) => void }) {
  const [formData, setFormData] = useState({
  ...
  if (!user) {
    return (
      <motion.div
        ...
        className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm"
      >
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl w-full max-w-sm text-center space-y-4 transition-colors">
          <div className="bg-amber-100 dark:bg-amber-900/30 p-3 rounded-full text-amber-600 dark:text-amber-400 w-fit mx-auto">
            <LogIn size={24} />
          </div>
          <h2 className="text-lg font-bold dark:text-white">Login Required</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Please login to your account to register a new service.</p>
          <button
            onClick={onClose}
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">{serviceToEdit ? 'Edit Service' : 'Register New Service'}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <select
                required
                className="w-full p-3 bg-gray-50 dark:bg-gray-700 rounded-xl outline-none focus:ring-1 focus:ring-blue-500 dark:text-white transition-colors"
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full p-3 bg-gray-50 dark:bg-gray-700 rounded-xl outline-none focus:ring-1 focus:ring-blue-500 min-h-[100px] resize-none dark:text-white transition-colors"
        ...
        <div className="relative h-64 bg-gray-100 dark:bg-gray-900 group flex-shrink-0 transition-colors">
          ...
          {photos.length > 1 && (
            <>
              <button
                onClick={prevPhoto}
                className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-white/50 dark:bg-black/50 hover:bg-white/80 dark:hover:bg-black/80 rounded-full text-gray-800 dark:text-gray-200 transition-colors"
              >
                <ChevronLeft size={20} />
              </button>
              <button
                onClick={nextPhoto}
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/50 dark:bg-black/50 hover:bg-white/80 dark:hover:bg-black/80 rounded-full text-gray-800 dark:text-gray-200 transition-colors"
              >
          ...
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 p-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-full text-gray-800 dark:text-gray-200 shadow-sm transition-colors"
          >
            <X size={20} />
          </button>
        ...
        <div className="p-6 space-y-6">
          ...
          {user && (
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl space-y-3 transition-colors">
              <div className="flex justify-between items-center">
                <h3 className="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase tracking-wider">Rate this service</h3>
                {hasChanged && (
                  <button 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-2xl space-y-1 transition-colors">
              ...
              <p className="text-sm font-medium text-gray-700 dark:text-gray-200">{service.operatingHours}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-2xl space-y-1 transition-colors">
              <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400">
                <Phone size={16} />
              ...
              <p className="text-sm font-medium text-gray-700 dark:text-gray-200">{service.contactNumber}</p>
            </div>
          </div>

          <a
            href={`tel:${service.contactNumber}`}
            className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-blue-200 dark:shadow-none active:scale-95 transition-transform"
          >
            <Phone size={20} />
            Call Provider
          </a>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                type="password"
                required
                className={`w-full p-3 rounded-xl text-sm outline-none focus:ring-1 focus:ring-blue-500 ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-50 text-gray-900'}`}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl transition-colors">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800 dark:text-gray-200">Status of Register</h4>
            ...
            <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl transition-colors">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800 dark:text-gray-200">Nudge Function</h4>
                <p className="text-[10px] text-gray-500 dark:text-gray-400">If approval takes too long, use the Nudge button to remind the admin.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl transition-colors">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800 dark:text-gray-200">Edit and Resubmit</h4>
            ...
            <div className="flex items-start gap-3 bg-gray-50 dark:bg-gray-700 p-3 rounded-2xl transition-colors">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800 dark:text-gray-200">Delete Function</h4>
