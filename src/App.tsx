              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm space-y-3 border border-gray-100">
                ...
                <div className="space-y-3 py-2">
                  <div className="flex justify-between items-center">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Rating Range</label>
                  ...
                  <div className="relative h-6 flex items-center">
                    ...
                    <input
                      ...
                      className="absolute w-full h-1.5 appearance-none bg-transparent pointer-events-none z-20 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-blue-600 [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md"
                    />
                    <input
                      type="range"
                      min="0"
                  ...
                  <div className="flex justify-between px-1">
                    {[0, 1, 2, 3, 4, 5].map(tick => (
                      <span key={tick} className="text-[10px] text-gray-400 font-medium">{tick}</span>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4 w-full">
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm font-semibold text-gray-800">support@servicecall.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                    <div className="bg-white p-2 rounded-lg shadow-sm text-blue-600">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm font-semibold text-gray-800">+60 12-345 6789</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                    <div className="bg-white p-2 rounded-lg shadow-sm text-blue-600">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm font-semibold text-gray-800">Kuala Lumpur, Malaysia</p>
                    </div>
                  </div>
                </div>
                <button
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1, y: 0 }}
        className="bg-white w-full max-w-sm rounded-3xl p-6 space-y-6 shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-bold text-gray-900">Service Registered!</h2>
          <p className="text-sm text-gray-500">Your added service notified our admin for approval. Please wait for the approval.</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-2xl">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800">Status of Register</h4>
                <p className="text-[10px] text-gray-500">Check if your service is Pending, Approved, or Rejected in your profile.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-2xl">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800">Nudge Function</h4>
                <p className="text-[10px] text-gray-500">If approval takes too long, use the Nudge button to remind the admin.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-2xl">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800">Edit and Resubmit</h4>
                <p className="text-[10px] text-gray-500">Need to change details? Edit anytime. If rejected, fix and resubmit!</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-gray-50 p-3 rounded-2xl">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-800">Delete Function</h4>
                <p className="text-[10px] text-gray-500">No longer providing the service? Delete it permanently from your profile.</p>
              </div>
            </div>
          </div>
        </div>
...
function GuestFindGuide({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-bold text-gray-900">How to Find Services</h2>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-[2] bg-blue-600 text-white py-3 rounded-xl font-bold shadow-lg shadow-blue-200"
          >
...
function UserRatingGuide({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-bold text-gray-900">How to Rate Services</h2>
          <span className="text-xs font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-full">
            {step + 1} / {steps.length}
          </span>
        </div>
